    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="flex justify-end gap-4 mb-4">
        ...
        <button
          ...
          title="Comparar Países Seleccionados"
        >
          <svg
        ...
        <button
          ...
          :title="showFavoritesOnly ? 'Mostrar Todos los Países' : 'Mostrar Solo Favoritos'"
        >
          <svg
            class="w-6 h-6"
        ...
        >
          ...
          <span class="hidden sm:inline text-gray-900 dark:text-white">Exportar</span>
        </button>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
        <div class="p-6 sm:p-10">
          <h1 class="text-4xl font-bold text-center mb-8 text-gray-800 dark:text-white">Explorador de Países</h1>
          ...
          <div class="flex justify-between items-center mb-6 text-sm text-gray-600 dark:text-gray-400">
            <div class="flex gap-4">
              ...
              <span>Filtrados: {{ filteredCountries.length }}</span>
            </div>
            <div class="flex gap-4">
              <span>Favoritos: {{ favorites.length }}</span>
              <span>Seleccionados para Comparar: {{ comparisonList.length }}/3</span>
            </div>
          </div>
